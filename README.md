# 📓 Exposition Engineering: Article Peer Reviews
...
* [📓 Exposition Engineering: Article Peer Reviews](#-exposition-engineering-article-peer-reviews)
...
This project invites you to report and reflect on the peer review process
during the completion of the three articles that you write in the field of
exposition engineering. In addition to writing all of the required content in
the file that contains a list of your article peer reviews and your reflection
on the peer review process, you will practice the use of `git` and GitHub and
...
[exposition-engineering-article-peer-reviews-starter](https://github.com/ExpositionEngineering/exposition-engineering-article-peer-reviews-starter);
...
This assignment invites you to report on the peer reviews that you completed
and received. You must read all of the `TODO` markers inside of the
`writing/article_peer_reviews.md` file and write the content and take the steps
that they require. Please see the course instructor if you have questions about
any aspect of the peer review process for your writing about the articles.
...
technical writing prompts in the `writing/article_peer_reviews.md` file.
